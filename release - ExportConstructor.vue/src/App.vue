                ...
                .then((res) => {
                    ...
                    for (let i = 0; i < request.length; i++) {
                        ...
                        if (el.id == "template_settings") {
                            ...
                            el.format =
                            el.format.split("_")[0] + "_" + this.getRequestLang();
                            ...
                            this.selectOption("orientation", orientation[el.orientation]);
                            this.selectOption("menu", "Проект");
                            this.updateCheckbox("content", el.content);
                            this.updateCheckbox("full_page_title", el.full_page_title);
                            this.updateCheckbox("merge_cells", el.merge_cells);
                        }
                        else {
