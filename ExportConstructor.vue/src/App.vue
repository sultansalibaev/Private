<template>
    <Content
        ...
        :powerpointElementList="powerpointElementList"
        :wordElementList="wordElementList"
        :excelElementList="excelElementList"
        :pdfElementList="pdfElementList"
        :error="error"
        :bluring="bluring"
    ...
    data() {
        return {
            ...
            powerpointElementList: [
                ...
                //         {
                //             id: "id-1_2",
                //             value: "projects", // YYYY-MM-DD HH:MM
                //             valueRU: "Проекты",
                //             parentElement: true,
                //             children: [
                //                 {
                            ...
                            children: [
                                ...
                                },
                                {
                                    ...
                                    children: [
                                        {
                                            id: "id-14_542",
                                            value: "Государственные источники",
                                            valueRU:
                                        ...
                                        {
                                            id: "id-14_543",
                                            value: "Информационные агентства",
                                            valueRU: "Информационные агентства",
                                            type: "draggable",
                                            selected: true,
                                        },
                                        {
                                            id: "id-14_541",
                                            value: "Региональные источники",
                                            valueRU: "Региональные источники",
                                            type: "draggable",
                                            selected: true,
                                        },
                                        {
                                            id: "id-14_541",
                                            value: "Электронные СМИ",
                                            valueRU: "Электронные СМИ",
                                            type: "draggable",
                                            selected: true,
                                        },
                                        {
                                            id: "id-14_541",
                                            value: "Специализированные",
                                            valueRU: "Специализированные",
                                            type: "draggable",
                                            selected: true,
                                        },
                                        {
                                            id: "id-14_541",
                                            value: "Зарубежные источники",
                                            valueRU: "Зарубежные источники",
                                            type: "draggable",
                                            selected: true,
                                        },
                                        {
                                            id: "id-14_541",
                                            value: "Государственные закупки",
                                            valueRU: "Государственные закупки",
                                            type: "draggable",
                                            selected: true,
                                        },
                                        {
                                        ...
                                        {
                                            id: "id-14_541",
                                            value: "Агрегаторы СМИ",
                                            valueRU: "Агрегаторы СМИ",
                                            type: "draggable",
                                            selected: true,
                                        },
                                    ],
            ...
            pdfElementList: [
                ...
                {
                    description:
                        "Вывод графика наиболее негативных источников.",
                    type: "grouped",
                    color: "#357EBD",
                    id: "id-13",
                    name: "top_negative",
                    groups: "groups",
                    nameRU: "Самые негативные источники в соцсети",
                    options: [
                        {
                            id: "id-13_1",
                            value: "title",
                                    ...
                                    children: [
                                        {
                                            id: "id-14_542",
                                            value: "Государственные источники",
                                            valueRU: "Государственные источники",
                                            type: "draggable",
                                            selected: true,
                                        },
                                        {
