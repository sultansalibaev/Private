                ...
                <div class="group__title group-bg flex items-center" v-else>
                    <span class="w-full cursor-pointer handle">
                        <label :for="'project-'+key.id" style="color:#eaeaea">
                            Проект: 
                            <input type="text" v-model="key.projectName" style="background: #54728f;border-radius: 3px;margin: 0 4px;width: 300px;">
                        </label>
                        <label :for="'number-'+key.id" style="color:#eaeaea">
                            его номер: 
                            <input type="number" v-model="key.projectId" style="background: #54728f;border-radius: 3px;margin: 0 4px;width: 70px;">
                        </label>
                    </span>
