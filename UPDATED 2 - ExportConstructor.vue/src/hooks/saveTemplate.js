...
export default function saveTemplateJSON(axios) {
    return function(request, formatFile) {
        ...
        var projectName = "Мой Конструктор"; // getConstructorName();
        ...
        axios({
            method: "post",
            url: "https://cabinet322.imas.kz/ru/reports/addreport", // https://export.imas.kz/test
            data: {
                name: projectName,
                format: formatFile,
                lang: lang,
